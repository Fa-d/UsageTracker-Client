...
import dev.sadakat.screentimetracker.core.database.dao.DailyScreenUnlockSummaryDao
import dev.sadakat.screentimetracker.core.database.entities.LimitedApp
import dev.sadakat.screentimetracker.core.database.dao.LimitedAppDao
import dev.sadakat.screentimetracker.core.database.dao.ScreenUnlockDao
import dev.sadakat.screentimetracker.core.database.entities.ScreenUnlockEvent
import dev.sadakat.screentimetracker.core.database.entities.Achievement
import dev.sadakat.screentimetracker.core.database.dao.AchievementDao
import dev.sadakat.screentimetracker.core.database.entities.WellnessScore
import dev.sadakat.screentimetracker.core.database.dao.WellnessScoreDao
import dev.sadakat.screentimetracker.core.database.entities.UserGoal
import dev.sadakat.screentimetracker.core.database.dao.UserGoalDao
import dev.sadakat.screentimetracker.core.database.entities.Challenge
import dev.sadakat.screentimetracker.core.database.dao.ChallengeDao
import dev.sadakat.screentimetracker.core.database.entities.FocusSession
import dev.sadakat.screentimetracker.core.database.dao.FocusSessionDao
import dev.sadakat.screentimetracker.core.database.entities.HabitTracker
import dev.sadakat.screentimetracker.core.database.dao.HabitTrackerDao
import dev.sadakat.screentimetracker.core.database.entities.TimeRestriction
import dev.sadakat.screentimetracker.core.database.dao.TimeRestrictionDao
...
class TrackerRepositoryImpl @Inject constructor(
    ...
    ): List<dev.sadakat.screentimetracker.data.local.AppLastOpenedData> {
    ...
    override fun getLastOpenedTimestampsForAppsInRangeFlow(
        startTime: Long, endTime: Long
    ): Flow<List<dev.sadakat.screentimetracker.data.local.AppLastOpenedData>> {
