...
/**
 * Primary GetDashboardDataUseCase implementation using clean architecture principles.
 * This is the authoritative implementation - all other versions should be removed.
 */
class GetDashboardDataUseCase(
    ...
    suspend operator fun invoke(timeRange: TimeRange = TimeRange.today()): DashboardData {
    ...
    fun observeDashboardData(timeRange: TimeRange = TimeRange.today()): Flow<DashboardData> {
        return combine(
...
/**
 * Dashboard data representation using pure domain models
 */
