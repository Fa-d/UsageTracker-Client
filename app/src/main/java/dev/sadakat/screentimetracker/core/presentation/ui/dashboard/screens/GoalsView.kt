...
import dev.sadakat.screentimetracker.core.presentation.ui.components.PlayfulMetricCard
import dev.sadakat.screentimetracker.core.presentation.ui.focus.components.FocusDurationDialog
import dev.sadakat.screentimetracker.core.presentation.ui.focus.viewmodels.FocusModeViewModel
import dev.sadakat.screentimetracker.core.presentation.ui.goals.components.GoalCreationDialog
import dev.sadakat.screentimetracker.core.presentation.ui.goals.viewmodels.UserGoalsViewModel
import dev.sadakat.screentimetracker.core.presentation.ui.limiter.screens.AppLimitSettingDialog
import dev.sadakat.screentimetracker.core.presentation.ui.limiter.viewmodels.LimiterConfigViewModel
import dev.sadakat.screentimetracker.core.presentation.ui.smartgoals.components.GoalRecommendationCard
import dev.sadakat.screentimetracker.core.presentation.ui.smartgoals.viewmodels.SmartGoalsViewModel
import dev.sadakat.screentimetracker.core.presentation.ui.theme.LavenderPurple
import dev.sadakat.screentimetracker.core.presentation.ui.theme.LimeGreen
import dev.sadakat.screentimetracker.core.presentation.ui.theme.PlayfulSecondary
                ...
                focusModeState.error?.let { error ->
                    ...
                    Box(
                        Modifier
                            .fillMaxWidth()
                            .background(
                                VibrantOrange.copy(alpha = 0.1f), shape = MaterialTheme.shapes.small
                            )
                            .padding(8.dp)
                    ) {
                        Text(
                                ...
                                Box(
                                    ...
                                    Box(
                                        Modifier
                                            ...
                                            .background(
                                                if (progress > 0.8f) VibrantOrange else Color(
                                                    0xFF2563EB
                                                ), shape = MaterialTheme.shapes.extraLarge
                                            )
                                    )
