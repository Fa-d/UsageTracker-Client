...
class SmartUsageTrackingService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START_SMART_TRACKING = "com.example.screentimetracker.ACTION_START_SMART_TRACKING"
        const val ACTION_STOP_SMART_TRACKING = "com.example.screentimetracker.ACTION_STOP_SMART_TRACKING"
        const val ACTION_CHECK_LIMITS = "com.example.screentimetracker.ACTION_CHECK_LIMITS"
