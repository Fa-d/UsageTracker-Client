...
import com.example.screentimetracker.data.local.DailyAppSummary // Import if using directly
import com.example.screentimetracker.data.local.DailyScreenUnlockSummary // Import if using directly
