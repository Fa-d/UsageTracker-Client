...
import com.example.screentimetracker.data.local.PetType
import com.example.screentimetracker.data.local.WellnessFactors
import com.example.screentimetracker.ui.dashboard.state.DashboardState
import com.example.screentimetracker.utils.DigitalPetManager
...
class DigitalPetRepository @Inject constructor(
    ...
    suspend fun updatePetWithWellness(
        ...
        wellnessScore: com.example.screentimetracker.domain.model.WellnessScore? = null
    ): DigitalPet {
        var pet = getPetSync()
